...
curl https://yadu-public.s3.ca-central-1.amazonaws.com/liquibase-4.3.5.zip -o ./liquibase-4.3.5.zip
# unzip -q -o liquibase-4.3.5.zip
unzip -o liquibase-4.3.5.zip
...
curl https://yadu-public.s3.ca-central-1.amazonaws.com/mysql-connector-java-8.0.24.jar -o ./mysql-connector-java-8.0.24.jar
